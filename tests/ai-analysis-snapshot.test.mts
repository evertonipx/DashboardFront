...
const snapshotModule = loadTypeScriptModule<typeof import("../lib/ai-analysis-snapshot.ts")>("lib/ai-analysis-snapshot.ts");
const contract = loadTypeScriptModule<typeof import("../lib/ai-insights-contract.ts")>("lib/ai-insights-contract.ts");
...
function createFixtureSnapshot({ charts, dataCompleteUntil, subtitle }: Pick<import("../lib/report-export.ts").ReportPayload, "charts" | "dataCompleteUntil" | "subtitle">) {
