...
import type { CardLayoutPackingItem, CardLayoutPlacement } from "../lib/card-layout-packing.ts";

// tsx handles CommonJS .ts directly on Node 20 as well as newer Node versions.
const require = createRequire(import.meta.url);
const cardLayoutPacking: typeof import("../lib/card-layout-packing.ts") = require("../lib/card-layout-packing.ts");
const cardLayoutSizing: typeof import("../lib/card-layout-sizing.ts") = require("../lib/card-layout-sizing.ts");
...
test("packer suporta as 36 dimensões em todos os tiers responsivos", () => {
  for (const tier of ["single", "two-column", "three-column", "desktop"] as const) {
...
function assertPackingIsValid(placements: CardLayoutPlacement[], sourceItems: CardLayoutPackingItem[], columnCount: number) {
  assert.deepEqual(
