...
/**
 * Certifies that every aggregate bucket belongs to the exact half-open
 * interval requested by the client. A backend response outside [from, to)
 * is rejected instead of being silently mixed into another civil period.
 */
