...
function publicRouteErrorMessage(code: string) {
  const messages: Record<string, string> = {
    ...
    invalid_session_payload: "A sessão autenticada retornou dados inválidos.",
    ...
    invalid_time_zone: "A captura não possui um fuso IANA válido.",
    ...
    payload_too_large: "A captura excede o limite permitido para análise.",
    unsupported_media_type: "Envie a captura como JSON.",
    ...
    permissions_unavailable: "Não foi possível certificar as permissões do usuário.",
    company_modules_unavailable: "Não foi possível certificar os módulos da empresa.",
    invalid_permissions: "A API retornou permissões inválidas.",
    invalid_company_modules: "A API retornou módulos empresariais inválidos.",
    authentication_unavailable: "Não foi possível validar a sessão neste momento.",
    backend_configuration: "A integração com a API não está configurada.",
  };
